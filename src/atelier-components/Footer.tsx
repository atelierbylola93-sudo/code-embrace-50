...
export default function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer id="main-footer" className="bg-[#1E1E1E] text-white pt-20 pb-8 mt-24 border-t-2 border-[#C7A46A]/25 relative overflow-hidden">
      <SchemaLocalBusiness />
      
      {/* Background Subtle Gradient Glow */}
      <div className="absolute top-0 right-0 h-96 w-96 rounded-full bg-[#C7A46A]/5 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 h-96 w-96 rounded-full bg-[#A8B29A]/5 blur-[120px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 pb-16 border-b border-white/10">
          ...
          <div className="space-y-6">
            <div className="flex items-baseline gap-1 focus:outline-none select-none">
              ...
              <span className="font-signature text-3xl text-[#C7A46A] italic ml-1 select-none">
                by Lola
              </span>
            </div>
            ...
            <div className="space-y-3.5 text-xs md:text-sm text-gray-300">
              <div className="flex items-start gap-3">
                <MapPin className="h-5 w-5 text-[#C7A46A] shrink-0 mt-0.5" />
                <span>{INSTITUT_INFO.address}</span>
              </div>
              <div className="flex items-center gap-3">
                <Phone className="h-5 w-5 text-[#C7A46A] shrink-0" />
                <a href={`tel:${INSTITUT_INFO.phoneFormatted}`} className="hover:text-[#C7A46A] transition-colors">{INSTITUT_INFO.phone}</a>
              </div>
              <div className="flex items-start gap-3">
                <Clock className="h-5 w-5 text-[#C7A46A] shrink-0 mt-0.5" />
          ...
          <div className="space-y-4">
            <h4 className="font-serif text-lg font-medium text-white tracking-wider border-l-2 border-[#C7A46A] pl-3">Prestations</h4>
            <ul className="space-y-2.5 text-xs md:text-sm text-gray-400">
              {NAV_ITEMS.slice(1).map((item) => (
                <li key={`footer-nav-${item.page}`}>
                  <button
                    onClick={() => handleLinkClick(item.page)}
                    className="hover:text-[#C7A46A] transition-colors duration-200 cursor-pointer flex items-center gap-1.5"
                  >
                    <span>{item.name}</span>
                  </button>
                </li>
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <h4 className="font-serif text-lg font-medium text-white tracking-wider border-l-2 border-[#C7A46A] pl-3">Espace Conseils (Blog)</h4>
              <ul className="space-y-2.5 text-xs text-gray-400">
                <li className="p-2.5 bg-white/5 rounded-lg border border-white/5 hover:border-[#C7A46A]/20 transition-all duration-300">
                  <span className="text-[10px] uppercase font-bold text-[#C7A46A] block">Head Spa Japonais</span>
                ...
                <li className="p-2.5 bg-white/5 rounded-lg border border-white/5 hover:border-[#C7A46A]/20 transition-all duration-300">
                  <span className="text-[10px] uppercase font-bold text-[#A8B29A] block">HydraFacial Glow</span>
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="flex gap-3">
                <a href={INSTITUT_INFO.instagramUrl} target="_blank" rel="noopener noreferrer" className="h-9 w-9 rounded-full bg-white/5 flex items-center justify-center text-gray-300 hover:bg-[#C7A46A] hover:text-white transition-all duration-300" title="Instagram">
                  <Instagram className="h-4 w-4" />
                </a>
                <a href={INSTITUT_INFO.tiktokUrl} target="_blank" rel="noopener noreferrer" className="h-9 w-9 rounded-full bg-white/5 flex items-center justify-center font-bold text-gray-300 hover:bg-[#A8B29A] hover:text-white transition-all duration-300" title="TikTok">
          ...
          <div className="space-y-4">
            <h4 className="font-serif text-lg font-medium text-white tracking-wider border-l-2 border-[#C7A46A] pl-3">Accès & Plan</h4>
            
            {/* Embedded Google Map */}
            <div className="w-full h-44 rounded-[24px] overflow-hidden border-2 border-[#C7A46A]/20 shadow-md group relative">
              <iframe
            ...
            <a
              ...
              className="text-xs text-[#C7A46A] hover:underline flex items-center gap-1 font-medium justify-center md:justify-start"
            >
