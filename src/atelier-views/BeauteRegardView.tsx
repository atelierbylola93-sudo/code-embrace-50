      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 py-16 grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-8 space-y-8">
          <div className="space-y-4">
            <span className="text-xs uppercase tracking-[0.2em] text-[#C7A46A] font-bold">L'Art de la Symétrie</span>
              ...
              >
                ...
                <div className="mt-6 pt-4 border-t border-[#F8F5F0] flex items-center justify-between text-xs">
                  <span className="text-secondary-gray flex items-center gap-1">
                    <Sparkles className="h-3 w-3 text-[#C7A46A]" /> Formules enrichies en Kératine
                  </span>
                  <a
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <div className="bg-[#1E1E1E] text-white p-8 rounded-[24px] shadow-lg border-t-4 border-[#C7A46A] space-y-6 relative overflow-hidden">
            ...
            <span className="text-[10px] uppercase tracking-[0.2em] text-[#C7A46A] font-bold block">Des Cils en bonne santé</span>
            ...
            <div className="p-4 bg-white/5 rounded-lg border border-white/10 text-xs text-gray-400 space-y-1">
              <span className="text-[#A8B29A] font-semibold block">💧 Note importante :</span>
