  ...
  return (
    <div id="home-view" className="w-full relative bg-beige-bg">
      ...
      <section className="relative z-20 -mt-10 max-w-5xl mx-auto px-4">
        <div className="bg-white rounded-[28px] border border-[#B88F4D]/15 shadow-xl py-8 px-6 md:px-12 grid grid-cols-2 lg:grid-cols-4 gap-8 text-center divide-y lg:divide-y-0 lg:divide-x divide-[#B88F4D]/10">
      ...
      <section className="py-24 bg-white border-y border-[#B88F4D]/10">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          {/* Vignelli Swiss Rule major header line */}
          <div className="w-full border-t-2 border-charcoal/10 pt-4 mb-16 flex justify-between items-baseline font-mono text-[9px] tracking-[0.25em] text-secondary-gray uppercase select-none">
      ...
      <section className="py-24 bg-[#EFE7D2]">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="flex flex-col md:flex-row items-start justify-between mb-16 gap-6">
            <div className="space-y-4">
              <span className="text-[10px] font-mono uppercase tracking-[0.25em] text-[#B88F4D] font-bold block">
            ...
            <div className="flex items-center gap-4 bg-white px-6 py-4 rounded-[24px] border border-[#B88F4D]/20 shadow-sm">
              <div className="text-center">
                <span className="block font-serif text-3xl font-bold text-charcoal">4.9<span className="text-[#B88F4D] text-sm font-medium">/5</span></span>
                <span className="text-[9px] text-[#secondary-gray] uppercase font-bold tracking-wider block mt-0.5">Note globale</span>
              </div>
              <div className="h-10 w-[1px] bg-[#B88F4D]/30" />
              <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {REVIEWS.map((review, i) => (
              <motion.div
                key={`rev-v2-${i}`}
                className="bg-white border border-[#B88F4D]/10 rounded-[24px] p-6 flex flex-col justify-between relative overflow-hidden group hover:shadow-md transition-all duration-300"
                initial={{ opacity: 0, y: 15 }}
              ...
              >
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="h-10 w-10 text-xs font-bold text-white uppercase bg-charcoal rounded-full flex items-center justify-center border border-[#B88F4D]/40 group-hover:bg-[#B88F4D] transition-colors duration-300">
                      {review.avatar}
                    </span>
                ...
                <div className="pt-5 mt-6 border-t border-[#B88F4D]/10 flex justify-between items-center">
                  <span className="text-xs font-serif font-bold text-charcoal">{review.author}</span>
                  <span className="text-[9px] text-[#A3A485] font-bold uppercase tracking-wider bg-[#A3A485]/10 px-2.5 py-0.5 rounded-full">
                    Soin Vérifié
                  </span>
                </div>
              </motion.div>
      ...
      <section className="py-24 bg-white border-y border-[#B88F4D]/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16 space-y-3">
            <span className="text-xs uppercase tracking-[0.25em] text-[#B88F4D] font-bold block">
              Centre de Connaissances
            </span>
            <h2 className="font-serif text-3xl md:text-5xl text-charcoal font-medium">
              Questions Fréquentes de l’Atelier
            </h2>
            <div className="h-[1.5px] w-16 bg-[#B88F4D] mx-auto" />
          ...
          <div className="mt-12 text-center p-8 rounded-[28px] bg-beige-bg border border-[#B88F4D]/15 shadow-sm space-y-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
              ...
              >
                <Instagram className="h-4 w-4 text-[#B88F4D]" /> Échanger sur Instagram
              </a>
              <motion.button
                onClick={() => {
                  window.location.hash = '#/reservation';
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {INSTAGRAM_FEED.map((item) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group relative aspect-square rounded-[24px] overflow-hidden border border-[#B88F4D]/10 shadow-sm block"
              >
                <img
                  src={item.url}
          ...
          <div className="text-center mt-10">
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-[24px] border border-[#B88F4D]/30 px-6 py-3.5 text-xs uppercase tracking-wider font-semibold text-charcoal hover:bg-[#B88F4D] hover:text-white transition-all duration-300"
              whileHover={{ scale: 1.03 }}
              whileTap={{ scale: 0.95 }}
            >
  ...
  const faqs = [
    {
      ...
      answer: "Lola réalise une vraie thérapie capillaire privatisée. Dans un espace calme baigné d'huiles essentielles bio et de sonorités zen, votre cuir chevelu passe par un examen haute définition personnalisé, un massage d'acupression crâniene japonaise Shiatsu, l'arche d'eau chaude brevetée en massage continu et un dôme de vapeur purifié ionisant."
    },
    {
      id: "hs-2",
      category: 'head-spa',
          ...
          <button
            ...
            className={`px-4 py-2 border rounded-full text-xs font-semibold tracking-wider whitespace-nowrap transition-all duration-300 cursor-pointer ${
              activeCategory === cat.id
                ...
                : 'bg-white text-secondary-gray border-[#B88F4D]/20 hover:border-[#B88F4D]'
            }`}
          >
            {cat.name}
          </button>
      ...
      <div className="space-y-3">
        {filteredFaqs.map((faq) => {
          ...
          return (
            <div
              key={faq.id}
              className="bg-[#EFE7D2] border border-[#B88F4D]/10 rounded-[20px] overflow-hidden transition-all duration-300"
            >
              <button
                onClick={() => setOpenFaqId(isOpen ? null : faq.id)}
                className="w-full flex justify-between items-center px-6 py-4.5 text-left text-xs md:text-sm font-semibold tracking-wide text-charcoal hover:text-[#B88F4D] transition-colors focus:outline-none"
              >
                <span className="pr-4">{faq.question}</span>
                {isOpen ? (
                  <ChevronUp className="h-4 w-4 text-[#B88F4D] shrink-0" />
                ) : (
              ...
              <AnimatePresence initial={false}>
                {isOpen && (
                  ...
                  >
                    <div className="px-6 pb-5 pt-1 text-xs text-secondary-gray leading-relaxed font-light border-t border-[#B88F4D]/10 bg-white/50">
                      {faq.answer}
                    </div>
                  </motion.div>
                )}
